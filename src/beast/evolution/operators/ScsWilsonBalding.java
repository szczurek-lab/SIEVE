...
@Description("Modified based on WilsonBalding move")
public class ScsWilsonBalding extends TreeOperator {
    ...
    public double proposal() {
        ...
        // choose a random node avoiding tree root and sample root
        ...
        // disallow moves that change the root and the trunk.
        if (j.isRoot() || ((ScsNode) j).isTMRCA() || p.isRoot() || ((ScsNode) p).isTMRCA()) {
