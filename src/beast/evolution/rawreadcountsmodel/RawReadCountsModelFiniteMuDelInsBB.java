...
@Description("An error model compatible with ScsFiniteMuDelInsModel")
public class RawReadCountsModelFiniteMuDelInsBB extends RawReadCountsModelInterface.Base {
...
//
//        // 5 situations
//        this.situationLikelihoods = new double[5];
//    } // initAndValidate

//    /**
//     * update situation likelihoods for five situations
//     *
...
//        final double f4 = 1.0 / 3 - seqErr.getValue() / 9;
//        final double f5 = 2.0 / 3 - 5 * seqErr.getValue() / 9;
...
//        situationLikelihoods[3] = ((BetaBinomial) variantDensity).density(variantReads, seqCov, f4 * w2, w2 * (1 - f4));
//        situationLikelihoods[4] = ((BetaBinomial) variantDensity).density(variantReads, seqCov, f5 * w2, w2 * (1 - f5));
...
//                if (singleADO) {
//                    // single ado
//                    lh = (1 - theta) * situationLikelihoods[0] * seqCovLikelihoods[taxonIndex][index + 3] + theta * situationLikelihoods[0] * seqCovLikelihoods[taxonIndex][index + 2];
//                } else {
//                    // locus ado
//                    lh = Math.pow(1 - theta, 3) * situationLikelihoods[0] * seqCovLikelihoods[taxonIndex][index + 3] + 3 * theta * Math.pow(1 - theta, 2) * situationLikelihoods[0] * seqCovLikelihoods[taxonIndex][index + 2] + 3 * Math.pow(theta, 2) * (1 - theta) * situationLikelihoods[0] * seqCovLikelihoods[taxonIndex][index + 1] + Math.pow(theta, 3) * seqCovLikelihoods[taxonIndex][index];
//                }
//                break;
//            case 1:
//            case 2:
...
//                if (singleADO) {
//                    // single ado
//                    lh = (1 - theta) * situationLikelihoods[3] * seqCovLikelihoods[taxonIndex][index + 3] + theta * ((situationLikelihoods[0] + 2 * situationLikelihoods[2]) / 3) * seqCovLikelihoods[taxonIndex][index + 2];
//                } else {
//                    // locus ado
//                    lh = Math.pow(1 - theta, 3) * situationLikelihoods[3] * seqCovLikelihoods[taxonIndex][index + 3] + theta * Math.pow(1 - theta, 2) * (situationLikelihoods[0] + 2 * situationLikelihoods[2]) * seqCovLikelihoods[taxonIndex][index + 2] + Math.pow(theta, 2) * (1 - theta) * (2 * situationLikelihoods[0] + situationLikelihoods[1]) * seqCovLikelihoods[taxonIndex][index + 1] + Math.pow(theta, 3) * seqCovLikelihoods[taxonIndex][index];
//                }
//                break;
//            case 3:
//                // 0/11
//                if (singleADO) {
//                    // single ado
//                    lh = ((1 - theta) / 2) * (situationLikelihoods[3] + situationLikelihoods[4]) * seqCovLikelihoods[taxonIndex][index + 3] + theta * ((2 * situationLikelihoods[2] / 3) + (situationLikelihoods[1] + situationLikelihoods[2]) / 6) * seqCovLikelihoods[taxonIndex][index + 2];
//                } else {
//                    // locus ado
//                    lh = (Math.pow(1 - theta, 3) / 2) * (situationLikelihoods[3] + situationLikelihoods[4]) * seqCovLikelihoods[taxonIndex][index + 3] + theta * Math.pow(1 - theta, 2) * (2 * situationLikelihoods[2] + (situationLikelihoods[1] + situationLikelihoods[2]) / 2) * seqCovLikelihoods[taxonIndex][index + 2] + Math.pow(theta, 2) * (1 - theta) * (situationLikelihoods[0] + 2 * situationLikelihoods[1]) * seqCovLikelihoods[taxonIndex][index + 1] + Math.pow(theta, 3) * seqCovLikelihoods[taxonIndex][index];
//                }
//                break;
//            case 4:
//                // 1/01
//                if (singleADO) {
//                    // single ado
//                    lh = (1 - theta) * ((2 * situationLikelihoods[3] + situationLikelihoods[4]) / 3) * seqCovLikelihoods[taxonIndex][index + 3] + theta * (2 * situationLikelihoods[2] / 3 + (situationLikelihoods[1] + situationLikelihoods[2]) / 6) * seqCovLikelihoods[taxonIndex][index + 2];
//                } else {
//                    // locus ado
//                    lh = Math.pow(1 - theta, 3) * ((2 * situationLikelihoods[3] + situationLikelihoods[4]) / 3) * seqCovLikelihoods[taxonIndex][index + 3] + theta * Math.pow(1 - theta, 2) * (2 * situationLikelihoods[2] + (situationLikelihoods[1] + situationLikelihoods[2]) / 2) * seqCovLikelihoods[taxonIndex][index + 2] + Math.pow(theta, 2) * (1 - theta) * (situationLikelihoods[0] + 2 * situationLikelihoods[1]) * seqCovLikelihoods[taxonIndex][index + 1] + Math.pow(theta, 3) * seqCovLikelihoods[taxonIndex][index];
//                }
//                break;
//            case 5:
//                // 1/11
//                if (singleADO) {
//                    // single ado
//                    lh = (1 - theta) * (situationLikelihoods[1] / 6 + situationLikelihoods[3] / 6 + 2 * situationLikelihoods[4] / 3) * seqCovLikelihoods[taxonIndex][index + 3] + (theta / 2) * (situationLikelihoods[1] + situationLikelihoods[2]) * seqCovLikelihoods[taxonIndex][index + 2];
//                } else {
//                    // locus ado
//                    lh = Math.pow(1 - theta, 3) * (situationLikelihoods[1] / 6 + situationLikelihoods[3] / 6 + 2 * situationLikelihoods[4] / 3) * seqCovLikelihoods[taxonIndex][index + 3] + 1.5 * theta * Math.pow(1 - theta, 2) * (situationLikelihoods[1] + situationLikelihoods[2]) * seqCovLikelihoods[taxonIndex][index + 2] + 3 * Math.pow(theta, 2) * (1 - theta) * situationLikelihoods[1] * seqCovLikelihoods[taxonIndex][index + 1] + Math.pow(theta, 3) * seqCovLikelihoods[taxonIndex][index];
//                }
//                break;
//            case 6:
//            case 7:
...
//                if (singleADO) {
//                    // single ado
//                    lh = (1 - theta) * situationLikelihoods[0] * seqCovLikelihoods[taxonIndex][index + 2] + theta * situationLikelihoods[0] * seqCovLikelihoods[taxonIndex][index + 1];
//                } else {
//                    // locus ado
...
//            case 12:
//                // 0/-
//                // single ado and locus ado have the same form
//                lh = (1 - theta) * situationLikelihoods[0] * seqCovLikelihoods[taxonIndex][index + 1] + theta * seqCovLikelihoods[taxonIndex][index];
//                break;
//            case 13:
//                // 1/-
//                // single ado and locus ado have the same form
//                lh = (1 - theta) * situationLikelihoods[1] * seqCovLikelihoods[taxonIndex][index + 1] + theta * seqCovLikelihoods[taxonIndex][index];
//                break;
//            case 14:
//                // -
//                // single ado and locus ado have the same form
//                lh = seqCovLikelihoods[taxonIndex][index];
//                break;
//            default:
